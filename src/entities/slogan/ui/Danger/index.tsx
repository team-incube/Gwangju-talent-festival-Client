  ...
  return (
    <div className="border-gray-100 border border-solid text-caption1r h-[184px] overflow-y-scroll my-24 rounded-lg p-12">
      ...
      <ul className="list-disc pl-16 marker:text-[10px]">
        ...
        <li>수상 후라도 이 사실이 밝혀질 경우, 수상 취소 및 상품 회수가 이루어집니다.</li>
      </ul>
      <h5>2. 저작권 책임은 응모자에게 있음</h5>
      <ul className="list-disc pl-16 marker:text-[10px]">
        <li>저작권법을 철저히 준수해야 합니다.</li>
        <li>저작권 관련 문제가 발생할 경우, 모든 법적 책임은 응모자에게 있음을 유의하세요.</li>
        <li>응모 전, 관련 문제를 완전히 해결한 후 제출해야 합니다.</li>
      </ul>
      <h5>3. 저작재산권 양도 의무</h5>
      <ul className="list-disc pl-16 marker:text-[10px]">
        <li>
          입상자는 수상과 동시에, 해당 작품의 저작재산권 및 일체의 권리를광주광역시교육청에 양도해야
          합니다.
        </li>
      ...
      <ul className="list-disc pl-16 marker:text-[10px]">
        ...
        <li>심사 결과에 따라, 입상작 전부 또는 일부가 선정되지 않을 수도 있습니다.</li>
      </ul>
      <h5>5. 활용 및 변경 가능성</h5>
      <ul className="list-disc pl-16 marker:text-[10px]">
        <li>광주광역시교육청은 입상작의 전체 또는 일부를 창작적으로 변경해 활용할 수 있습니다.</li>
