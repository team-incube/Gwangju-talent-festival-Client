  ...
  return (
    <div className="w-full flex flex-col gap-12 bg-white border border-gray-100 rounded-xl p-22">
      ...
      <canvas
        ...
        width={640}
        height={320}
        className="w-full h-[520px] tablet:h-[440px] mobile:h-[360px] touch-none select-none border border-gray-200 rounded-lg bg-white bg-[repeating-linear-gradient(180deg,transparent_0px,transparent_53px,#e2e2e2_53px,#e2e2e2_54px)]"
